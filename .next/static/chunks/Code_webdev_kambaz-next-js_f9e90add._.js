...
"[project]/Code/webdev/kambaz-next-js/app/(Kambaz)/Account/Signin/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Signin() {
    _s();
    const [credentials, setCredentials] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Code$2f$webdev$2f$kambaz$2d$next$2d$js$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    ...
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Code$2f$webdev$2f$kambaz$2d$next$2d$js$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const signin = ()=>{
        const user = __TURBOPACK__imported__module__$5b$project$5d2f$Code$2f$webdev$2f$kambaz$2d$next$2d$js$2f$app$2f28$Kambaz$292f$Database$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].users.find((u)=>u.username === credentials.username && u.password === credentials.password);
        if (!user) return;
        // Initialize the user's enrollments
        const userEnrollments = __TURBOPACK__imported__module__$5b$project$5d2f$Code$2f$webdev$2f$kambaz$2d$next$2d$js$2f$app$2f28$Kambaz$292f$Database$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].enrollments.filter((e)=>e.user === user._id);
        dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$Code$2f$webdev$2f$kambaz$2d$next$2d$js$2f$app$2f28$Kambaz$292f$Account$2f$reducer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setCurrentUser"])(user));
        dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$Code$2f$webdev$2f$kambaz$2d$next$2d$js$2f$app$2f28$Kambaz$292f$Enrollments$2f$reducer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setEnrollments"])(userEnrollments)); // <-- update Redux store
...
_s(Signin, "NfluHBcW7x7Mr+ngVXdEcXWodDo=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$Code$2f$webdev$2f$kambaz$2d$next$2d$js$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = Signin;
var _c;
...
//# sourceMappingURL=Code_webdev_kambaz-next-js_f9e90add._.js.map